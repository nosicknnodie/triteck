                  ...
                  <MDBTable bordered className="mt-5">
                    ...
                    <MDBTableBody>
                      <tr>
                        ...
                        <td>
                          Self pre-heating 높은 공기예열로 완전연소 구현 및
                          유해가스 완전 열분해
                        </td>
                      </tr>
                      <tr>
          ...
          <MDBRow className="text-center mt-5">
            <MDBCardBody className="pb-0">
              <MDBCol className="colCleanProjects mt-5 pb-5 dark-text">
                ...
                작업자의 숙련도를 높여 해체 공정 시스템 최적화 (ALARA)에 활용
                해체 공정 시스템에 사용되는 장비 에뮬레이션 모델을 통해 해체
                공정에 대한 모의실험으로 해체 공정 전략을 구축에 대한 안전성 및
                신뢰성 평가 기여.
              </MDBCol>
            </MDBCardBody>
          </MDBRow>
