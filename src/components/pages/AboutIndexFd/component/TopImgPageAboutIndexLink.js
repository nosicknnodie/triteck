...
import "./TopImgPageAboutIndexLink.css";
import {
  MDBContainer,
  MDBRow,
  MDBCol,
...
const TopImgPageAboutIndexLink = () => {
  return (
    <>
      <section id="TopImgPageAboutIndexLink">
            ...
            <MDBRow className="text-center mt-5">
              <MDBCol className="rowIconRot mt-5 pt-5 " sm="12">
                ...
                >
                  ...
                  <h6 className="mb-1 font-weight-bold">- 연구실적 -</h6>
                  ...
                  {/* <MDBBtn className="btnWeb" color="blue" outline rounded href="/pages/CeoFd/ceo">연구실적</MDBBtn>      
            <MDBBtn className="btnMobile" color="blue" rounded href="/pages/CeoFd/ceo">연구실적</MDBBtn>  
                       */}
                </MDBAnimation>
              </MDBCol>
            </MDBRow>
...
export default TopImgPageAboutIndexLink;
