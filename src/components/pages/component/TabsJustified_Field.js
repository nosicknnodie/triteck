...
class TabsJustified_Field extends Component {
  state = {
        ...
        <MDBNav tabs className="nav-justified" color="primary">
          ...
          <MDBNavItem>
            <NavLink
              ...
              role="tab"
            >
              <MDBIcon icon="file-alt" /> Document
            </NavLink>
          </MDBNavItem>
        </MDBNav>
        <MDBTabContent
...
export default TabsJustified_Field;
