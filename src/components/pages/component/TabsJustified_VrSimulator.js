...
class TabsJustified_VrSimulator extends Component {
  state = {
  ...
  render() {
    return (
      <MDBContainer>
        <MDBNav tabs className="nav-justified" color="info">
          <MDBNavItem>
            <NavLink
              link
              to="#"
              ...
              role="tab"
            >
              <MDBIcon icon="braille" /> Simulation1
            </NavLink>
          </MDBNavItem>
          <MDBNavItem>
            <NavLink
              ...
              role="tab"
            >
              <MDBIcon icon="sim-card" /> Simulation2
            </NavLink>
          </MDBNavItem>
          <MDBNavItem>
            <NavLink
              ...
              role="tab"
            >
              <MDBIcon icon="memory" /> Simulation3
            </NavLink>
          </MDBNavItem>
        </MDBNav>
        <MDBTabContent
...
export default TabsJustified_VrSimulator;
