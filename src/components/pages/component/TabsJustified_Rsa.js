...
class TabsJustified_Rsa extends Component {
  state = {
  ...
  render() {
    return (
      <MDBContainer>
        <MDBNav tabs className="nav-justified" color="secondary">
          <MDBNavItem>
            <NavLink
              link
              to="#"
          ...
          <MDBNavItem>
            <NavLink
              ...
              role="tab"
            >
              <MDBIcon icon="sim-card" /> Technology
            </NavLink>
          </MDBNavItem>
          <MDBNavItem>
            <NavLink
              ...
              role="tab"
            >
              <MDBIcon icon="memory" /> ART + Technology
            </NavLink>
          </MDBNavItem>
        </MDBNav>
        <MDBTabContent
...
export default TabsJustified_Rsa;
