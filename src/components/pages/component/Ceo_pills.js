              ...
              <MDBTabContent activeItem={this.state.items["default"]}>
                ...
                <MDBTabPane tabId="2">
                  ...
                  <p>
                    ...
                    기획(문화체육관광부) <br />
                    <br />
                    <spen style={{ fontWeight: "500" }}>역할:</spen>{" "}
                    수상레져스포츠 분과위원장 <br />
                    <spen style={{ fontWeight: "500" }}>내용:</spen>{" "}
                  ...
                  <p>
                    ...
                    <br />
                    <br />
                    <spen style={{ fontWeight: "500" }}>역할:</spen> 연구기획
                    위원장장 <br />
                    <spen style={{ fontWeight: "500" }}>내용:</spen> 2011년부터
                  ...
                  <p>
                    ...
                    <br />
                    <br />
                    <spen style={{ fontWeight: "500" }}>역할:</spen> 정보 및
                    서비스 분과위원장 <br />
                    <spen style={{ fontWeight: "500" }}>내용:</spen> 2018년
                  ...
                  <p>
                    ...
                    <spen style={{ fontWeight: "500" }}>내용:</spen> 스포츠
                    산업기술 중장기 전략 수립
                  </p>
                  ...
                  <p>
                    ...
                    <spen style={{ fontWeight: "500" }}>내용:</spen> 2014년
