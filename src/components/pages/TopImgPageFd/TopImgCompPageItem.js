...
import { MDBContainer, MDBAnimation, MDBRow, MDBCol, MDBCard, MDBCardBody, MDBMask, MDBIcon, MDBView, MDBBtn, MDBLink } from "mdbreact";
      ...
      <MDBContainer >
        <MDBRow>
          ...
          >             
            ...
            <MDBBtn className="btnWeb" color="white" outline rounded href={link}>{kor}</MDBBtn>      
            <MDBBtn className="btnMobile" color="white" rounded href={link}>{kor}</MDBBtn>  
