  ...
  return (
    <section id="jumbotronIdMobile">
      <MDBRow>
        ...
        <MDBCol md="12">
          <MDBRow>
            <MDBCol className="btnBox">개발내용</MDBCol>
          </MDBRow>
          <MDBCard className="mt-3">
            ...
            <MDBCardBody className="blueBoxColor white-text rounded-bottom">
              ...
              <MDBCardText className="white-text">
                ...
                기반의 팀단위 훈련이 가능한 대규모화재 진압훈련용 시뮬레이터.
                <br />
                <br />
              ...
              <MDBCardTitle className="cardTitle2">
        ...
        <MDBCol md="12">
          <MDBCard>
            ...
            <MDBCardBody className="blueBoxColor white-text rounded-bottom">
              ...
              <hr className="hr-light" />
              <MDBCardText className="white-text">
                정보통신기술 (ICT :Information & Communications Technology)과
                스포츠 기기가 융합된 스포츠콘텐츠 . 기존 전자호구 대비 경량화 및
                센서기능이 향상된 저거형의 수련용 전자호 개발
              </MDBCardText>
              {/* <a href='#!' className='black-text d-flex justify-content-end'>
              <h5 className='white-text'>
                Read more
